# Pickle Rick — Strengthening My Web Enumeration & Linux Skills

**Platform:** TryHackMe  
**Room:** Pickle Rick  
**Category:** Web Enumeration, Linux Enumeration, Privilege Escalation  
**Date:** 10 July 2026

After completing Basic Pentesting, I wanted to continue improving my web enumeration and Linux skills. Pickle Rick felt like a great follow-up because it focused on exploring a web application, gathering information, navigating a Linux system, and using privilege escalation to complete the objective.

I started by exploring the web application and inspecting everything that was publicly accessible. Instead of immediately looking for an exploit, I spent time checking the available pages, viewing the page source, and collecting every piece of information that could help me move forward.
...
Pickle Rick reinforced many of the concepts I learned in previous rooms while giving me more confidence with web enumeration, Linux navigation, and privilege escalation. More than anything, it reminded me that successful penetration testing isn't always about advanced exploits—it's about understanding the target, following the available clues, and making the best use of the tools you already have.
